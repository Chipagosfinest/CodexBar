...
- Dashboard: project live plugin spend history (OpenRouter Activity) onto the same cost field Codex and Claude already use, instead of leaving usage and spend out of sync (#3748). Thanks @Chipagosfinest!
