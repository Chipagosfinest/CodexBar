...
- Sharing: keep retained top-model families on the shared usage card when another provider in the same currency is unpriced or incomplete, and label that ranking as partial instead of showing an empty card. Thanks @Chipagosfinest!
